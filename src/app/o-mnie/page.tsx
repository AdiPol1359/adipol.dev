	...
	return (
		<>
			...
			<p className="mt-4 text-justify text-white-black">
				...
				Springu, ale ostatecznie poczułem, że te technologie nie są dla mnie.
				Aktualnie skupiam się na języku TypeScript i całym ekosystemie NodeJS.
				Głównie zajmuję się tworzeniem stron internetowych, zarówno od strony
